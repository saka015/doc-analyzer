          ...
          >
            <Paper sx={{ padding: 0 }}>
              <ClickAwayListener onClickAway={handleClose}>
                ...
                >
                  <MenuItem onClick={handleClose}><MdOutlineIndeterminateCheckBox className="text-xl"/></MenuItem>
                  <MenuItem onClick={handleClose}><MdOutlineCheckBox className="text-xl"/></MenuItem>
